...
const game={id:1,startsAt:"2099-01-01T00:00:00Z",uncertainty:40,away:{name:"Away",abbreviation:"AWY",winProbability:.38,starter:{playerId:10,expectedStrikeouts:6.2}},home:{name:"Home",abbreviation:"HME",winProbability:.62,starter:{playerId:11,expectedStrikeouts:5.8}},total:{line:8.5,overProbability:.58,underProbability:.42},firstFive:{awayWinProbability:.4,homeWinProbability:.6},firstInning:{nrfiProbability:.62,yrfiProbability:.38},lineups:{confirmed:true,away:[{id:20,name:"Hitter",onePlusHitProbability:.68,platoonAdjusted:true}],home:[]},quality:{teamRecords:true,starterStats:true,awayStarter:true,homeStarter:true,opponentStrikeouts:true,validatedMarkets:{moneyline:true,total:true,firstFive:true,firstInning:true,pitcherStrikeouts:true,hitterHits:true}}};
